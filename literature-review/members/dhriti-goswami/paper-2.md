...
| **Project Relevance** <br>*(1-2 lines)* | It is relevant to our Whole Genome Sequencing pillar - DeepVariant is the foundational deep convolutional network approach for variant calling our project builds on. |
